            ...
            <div className="glass p-6 rounded-2xl mb-12 border-indigo-500/20">
              <div className="flex gap-4 items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-2 italic">Follow the digital signage from the main gate.</p>
                </div>
              </div>
            </div>
              ...
              {rules.map((rule, i) => (
                <div key={i} className="glass rounded-xl overflow-hidden">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-5 text-left font-bold hover:bg-white/5 transition-colors"
                  >
                    <span>{rule.q}</span>
